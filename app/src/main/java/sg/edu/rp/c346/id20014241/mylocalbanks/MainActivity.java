package sg.edu.rp.c346.id20014241.mylocalbanks;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == 0){
            ...
            if (wordClicked.equalsIgnoreCase("DBS")){
                Intent intentRecieve = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: " + "1800 111 1111 "));
                startActivity(intentRecieve);

            }
            else if (wordClicked.equalsIgnoreCase("OCBC")){
                Intent intentRecieve = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: " + "1800 363 3333"));
                startActivity(intentRecieve);
            }
            else if(wordClicked.equalsIgnoreCase("UOB")){
                Intent intentRecieve = new Intent(Intent.ACTION_DIAL, Uri.parse("tel: " + "1800 222 2121"));
                startActivity(intentRecieve);
            }
        }
